...
import { IRmvTripsDto, IRmvTripDto } from '@smartmirror/shared'
            ...
            {this.state.dto.trips.map((trip: IRmvTripDto) =>
              <tr key={trip.tripId}>
                <td className='text-center'>
                  {this.formatTime(trip.startTimePlanned)}<br />
                ...
                <td className='text-center'>
                  {this.formatTime(trip.arrivalTimePlanned)}<br />
                ...
                <td className='text-center'>
                  {this.formatTime(trip.durationPlanned)}<br />
