...
import { IOpenStreetMapLocationDto } from '@smartmirror/shared'
...
class LocationSearch extends React.Component<IProps, IState>  {
    ...
    return (
      <Card title='Standorte hinzufügen'>
        <div className='input-group mb-3'>
          <input type='text' className='form-control' placeholder='z.B. Frankfurt am Main, Hauptbahnhof'
            value={this.state.searchText} onChange={this.onSearchTextChange} onKeyDown={this.onSearchTextKeyDown} />
  ...
  private async doSearch (): Promise<void> {
    const res: Array<IOpenStreetMapLocationDto> = await Api.get<Array<IOpenStreetMapLocationDto>>(`/v1/smartmirror/admin/common/locations/search/${this.state.searchText}`)
    this.setState({
      locations: res
    })
  }
