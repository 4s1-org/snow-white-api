...
import { ICommonSettingsDto } from '@smartmirror/shared'
              ...
              <div className='form-row'>
                ...
                <div className='col'>
                  <input className='form-control' type='time'
                    value={this.state.morningStart} onChange={this.onMorningStartChange} />
                </div>
                <div className='col'>
                ...
                <div className='col'>
                  <input className='form-control' type='time'
                    value={this.state.morningEnd} onChange={this.onMorningEndChange} />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className='form-row'>
                ...
                <div className='col'>
                  <input type='text' className='form-control'
                    value={this.state.morningEnd} readOnly style={{ width: 100 }} />
                </div>
                <div className='col'>
                  <label className='col-form-label'>bis</label>
                </div>
                <div className='col'>
                  <input type='text' className='form-control'
                    value={this.state.morningStart} readOnly style={{ width: 100 }} />
                </div>
              </div>
            </div>
          </div>
