...
import { IWeatherSettingsDto, ICommonLocationDto } from '@smartmirror/shared'
          ...
          <div className='form-group row'>
            ...
            <div className='col-sm-8'>
              ...
              <div className='text-right'>
                <a href='https://openweathermap.org/appid/' target='_blank' rel='noopener noreferrer'>API-Key beantragen</a>
              </div>
            </div>
          </div>
          <div className='form-group row'>
            ...
            <div className='col-sm-8'>
              <Select
                ...
                value={this.state.locations.filter((location: ICommonLocationDto): boolean =>
