...
import { ITimetableSettingsDto, ITimetableStationDto } from '@smartmirror/shared'
          ...
          <div className='form-group row'>
            ...
            <div className='col-sm-8'>
              ...
              <div className='text-right'>
                <a href='https://opendata.rmv.de/' target='_blank' rel='noopener noreferrer'>API-Key beantragen</a>
              </div>
            </div>
          </div>
          <div className='form-group row'>
