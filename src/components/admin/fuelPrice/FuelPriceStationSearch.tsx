...
import { ITankerkoenigStationDto, ICommonLocationDto, ICoordinatesDto } from '@smartmirror/shared'
...
class GasStationSearch extends React.Component<IProps, IState>  {
  ...
  private async doSearch (): Promise<void> {
    if (this.state.selectedLocation) {
      ...
      const res: Array<ITankerkoenigStationDto> = await Api.post<Array<ITankerkoenigStationDto>>(`/v1/smartmirror/admin/fuelprice/stations/search`, coords)
      this.setState({
        stations: res
      })
    }
