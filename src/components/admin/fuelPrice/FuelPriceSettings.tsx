...
import { IFuelPriceSettingsDto, IFuelPriceStationDto } from '@smartmirror/shared'
          ...
          <div className='form-group row'>
            ...
            <div className='col-sm-8'>
              ...
              <div className='text-right'>
                <a href='https://creativecommons.tankerkoenig.de/' target='_blank' rel='noopener noreferrer'>API-Key beantragen</a>
              </div>
            </div>
          </div>
          <div className='form-group row'>
            ...
            <div className='col-sm-8'>
              <Select
                ...
                value={intervalOptions.filter((option: { value: number, label: string }): boolean =>
