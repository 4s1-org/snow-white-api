...
import Schneewitchen from '../../Schneewittchen.png'
      ...
      <div className='adminarea'>
        <Router>
          <nav className='navbar fixed-top navbar-expand-lg navbar-dark bg-dark'>
            <button type='button' onClick={this.toggleNavbar} className={`${classTwo}`}
              data-toggle='collapse' data-target='#navbarResponsive'>
              <span className='navbar-toggler-icon' />
            </button>
            <img src={Schneewitchen} width='40' height='40' alt='Smart Mirror' />
            <div className={`${classOne}`} id='navbarResponsive'>
              <ul className='navbar-nav mr-auto'>
                <li className='nav-item'>
                  <NavLink to='/admin/common' className='nav-link' activeClassName='active'
                    onClick={this.toggleNavbar}>Allgemein</NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink to='/admin/date' className='nav-link' activeClassName='active'
                    onClick={this.toggleNavbar}>Datum</NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink to='/admin/fuelPrice' className='nav-link' activeClassName='active'
                    onClick={this.toggleNavbar}>Kraftstoffpreise</NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink to='/admin/timetable' className='nav-link' activeClassName='active'
                    onClick={this.toggleNavbar}>Fahrplan</NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink to='/admin/traffic' className='nav-link' activeClassName='active'
                    onClick={this.toggleNavbar}>Verkehr</NavLink>
                </li>
                <li className='nav-item'>
                  <NavLink to='/admin/weather' className='nav-link' activeClassName='active'
                    onClick={this.toggleNavbar}>Wetter</NavLink>
                </li>
              </ul>
            </div>
          </nav>
