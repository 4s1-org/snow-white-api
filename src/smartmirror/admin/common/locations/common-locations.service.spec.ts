...
describe('CommonLocationsService', () => {
  ...
  beforeEach(async () => {
    ...
    repo = module.get<Repository<CommonLocationEntity>>(getRepositoryToken(CommonLocationEntity))
  ...
  it('SortNo should be less than max int size (2147483647)', async () => {
    ...
    // Act
    jest.spyOn(repo, 'insert').mockImplementationOnce((entity: CommonLocationEntity) => {
      // Assert
