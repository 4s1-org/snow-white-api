...
describe("Common Controller", () => {
  ...
  beforeEach(async () => {
    ...
    locationsService = module.get<CommonLocationsService>(
      CommonLocationsService,
    )
  ...
  describe("Locations", () => {
    it("GET /locations/search/:text", async () => {
      ...
      jest
        .spyOn(locationsService, "search")
        .mockImplementation(() => Promise.resolve(data))
      // Act
      const res: Array<OpenStreetMapLocationDto> = await controller.searchLocations(
        "foo",
      )
      // Assert
    ...
    it("GET /locations", async () => {
      ...
      jest
        .spyOn(locationsService, "loadAll")
        .mockImplementation(() => Promise.resolve(data))
      // Act
    ...
    it("POST /locations/:id", async () => {
      ...
      jest
        .spyOn(locationsService, "loadSingle")
        .mockImplementation(() => Promise.resolve(data))
      // Act
    ...
    it("PUT /locations/reorder", async () => {
      // Arrange
      jest
        .spyOn(locationsService, "reorderLocations")
        .mockImplementation(() => Promise.resolve())
      // Act
