...
describe('FuelPriceStationsService', () => {
  ...
  beforeEach(async () => {
    ...
    repo = module.get<Repository<FuelPriceStationEntity>>(getRepositoryToken(FuelPriceStationEntity))
  ...
  it('Search gas station', async () => {
    ...
    jest.spyOn(tankerkoenigService, 'searchStations').mockImplementation(() => Promise.resolve(resData))
    // Act
